...
struct HopperPersistentSplitKPipelineInplace {
...
#error "Outplace transpose is not implemented yet, please enable USE_INPALCE_TRI_TRANSPOSE_INPLACE_IMPL to use inplace transpose."
